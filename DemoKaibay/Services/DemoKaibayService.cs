...
{
    public class DemoKaibayService : IDemoKaibayService
    {
        ...
        public async Task<AuctionDetailsDto> GetAuctionDetails(int id)
        {
            ...
            if (auctionDetail.AuctionEnded < DateTime.Now)
            {
                ...
                auctionDetail.FinalPrice = auctionDetail.Bids.Any() ? auctionDetail.Bids.Max(x => x.Price) : MinimumIndex;
            }
        ...
        public static bool PriceComparaison(double bidPrice, double mainMaxAuctionPrice, bool isFirstPrice = false)
        {
            if (isFirstPrice)
            {
                return bidPrice >= mainMaxAuctionPrice;
            }
            else
            {
                return bidPrice > mainMaxAuctionPrice;
